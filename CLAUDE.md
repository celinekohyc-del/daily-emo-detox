...
Daily Emo Detox is a paid micro-tool where users tap an emotion icon, receive AI-backed coping advice, and pay for unlimited access — turning emotional check-ins into a sustainable wellness habit.
...
- **Commit as your GitHub identity, or Vercel will block the deploy.** Vercel verifies that
  ...
  ```
  git config user.email "238494471+celinekohyc-del@users.noreply.github.com"
  git config user.name "celinekohyc-del"
  ```
